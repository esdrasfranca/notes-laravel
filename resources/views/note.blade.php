            ...
            <div class="row">
                <div class="col">
                    ...
                    <small class="text-secondary">
                        <span class="opacity-75 me-2">Created at:</span><strong>{{date('d/m/Y H:i:s', strtotime($note['created_at']))}}</strong> 
                        @if ($note['updated_at'] && $note['updated_at'] != $note['created_at'])
                            <span class="opacity-75 me-2 ms-5">Updated at:</span><strong>{{date('d/m/Y H:i:s', strtotime($note['updated_at']))}}</strong>    
                        @endif
                    </small>
                </div>
